...
Run `matrix-v1` · 8 retrieval configurations × 70 test questions · generator `qwen3.5:4b`, judge `gemma4:12b`.
...
|---|---|---|---|---|---|---|---|---|
| sentence_window · BM25+bge-small (weighted a=0.4) · no rerank · contract | 0.58 | 0.63 [0.53, 0.73] | 0.87 [0.80, 0.94] | 1.00 | 0.93 | 0.99 | 85 | 7031 |
...
| sentence_window · BM25 · no rerank · contract *(baseline)* | 0.52 | 0.52 [0.41, 0.63] | 0.87 [0.79, 0.94] | 0.96 | 0.86 | 0.99 | 0 | 6828 |
...
| sentence_window · BM25+bge-small (weighted a=0.4) · no rerank · contract | answer_correctness | +0.110 | [+0.025, +0.203] | yes |
| sentence_window · BM25+bge-small (weighted a=0.4) · no rerank · contract | faithfulness | +0.030 | [-0.035, +0.096] | no |
