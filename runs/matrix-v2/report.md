...
Run `matrix-v2` · 8 retrieval configurations × 70 test questions · generator `qwen3.5:4b`, judge `gemma4:12b` (grading rubric `contradiction-only-v5`).

Re-graded from `runs/matrix-v1`: same retrieval and answers; statement verdicts reused, correctness graded again.
...
|---|---|---|---|---|---|---|---|---|
| fixed · BM25 · no rerank · contract *(baseline)* | 0.85 | 0.75 [0.64, 0.84] | 0.62 [0.52, 0.73] | 0.87 | 0.91 | 0.97 | 0 | 9320 |
...
| fixed · BM25+bge-small (weighted a=0.4) · no rerank · contract | 0.84 | 0.73 [0.62, 0.83] | 0.71 [0.61, 0.82] | 0.92 | 0.89 | 0.98 | 15 | 9337 |
| section · BM25 · no rerank · contract *(baseline)* | 0.78 | 0.71 [0.60, 0.81] | 0.85 [0.77, 0.91] | 0.97 | 0.90 | 0.95 | 0 | 5647 |
| fixed · BM25 · minilm · contract | 0.80 | 0.70 [0.59, 0.80] | 0.55 [0.43, 0.66] | 0.86 | 0.87 | 0.97 | 80 | 10136 |
| sentence_window · BM25 · no rerank · contract *(baseline)* | 0.52 | 0.67 [0.57, 0.77] | 0.83 [0.75, 0.91] | 0.96 | 0.86 | 0.98 | 0 | 6828 |
| section · BM25+bge-base (RRF) · no rerank · contract | 0.74 | 0.65 [0.54, 0.76] | 0.86 [0.78, 0.92] | 0.98 | 0.87 | 0.96 | 32 | 5607 |
